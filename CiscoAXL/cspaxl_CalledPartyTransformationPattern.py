...
# *------------------------------------------------------------------
# * cspaxl_CalledPartyTransformationPattern.py
# *
# * Cisco AXL Python
# *
...
def Add(logger,csp_soap_client,cucm_variable_axl):
    ...
    logger.debug('Se ha entrado en la funcion Add del archivo cspaxl_CalledPartyTransformationPattern.py')
    axl_cucm = {}
    axl_cucm['pattern'] = cucm_variable_axl['DirectoryNumber']
    axl_cucm['description'] = 'DP_' + cucm_variable_axl['Country'] + '_' + cucm_variable_axl['SiteCode']
